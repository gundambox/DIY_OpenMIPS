...
`define InstructionValid        1'b0
`define InstructionInvalid      1'b1
...
`define InstructionAddressBus   31:0
`define InstructionBus          31:0
`define InstructionMemoryNum    131071
`define InstructionMemNumLog2   17
...
`define DataAddressBus          31:0
`define DataBus                 31:0
`define DataMemoryNumber        131071
`define DataMemoryNumLog2       17
`define ByteWidth               7:0

// Ctrl
`define Stop                    1'b1
`define NoStop                  1'b0
`define StopAllBus              5:0
...
`define CP0_REG_CAUSE           5'b01101 // Read        
`define CP0_REG_EPC             5'b01110 // Read Write         
`define CP0_REG_PrId            5'b01111 // Read         
`define CP0_REG_CONFIG          5'b10000 // Read      