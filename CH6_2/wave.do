...
add wave -noupdate -format Logic /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/id0/pre_instruction_is_load
...
WaveRestoreCursors {{Cursor 1} {479686 ps} 0}
...
update
WaveRestoreZoom {281749 ps} {580704 ps}
